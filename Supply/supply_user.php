...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['borrow_request'])) {
    ...
    if ($conn->query($sql)) {
        ...
        $conn->query("INSERT INTO supply_notifs (message, status, type) VALUES ('$note', 'unread', 'borrow')");
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="../index.php"><i class="fas fa-sign-out-alt me-1"></i>Return</a>
                </li>
            </ul>
        </div>
    </div>
