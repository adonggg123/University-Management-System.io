    ...
    <section id="home">
        ...
        <div class="container">
            <div class="nav-bar">
                ...
                <nav>
                    <ul>
                        ...
                        <li><button>+6395-1576-8931</button></li>
                    </ul>
                </nav>
            ...
            <div class="row">
                <div class="col">
                    <h1>Foodhub</h1>
                    <span>Make your day great with our special food!<br> <p>Welcome to our canteen where every bite tell's a story and every bite sparks a joy </p></span>
                   
                    
                       <div class="btn">
                        <div class="order">
                            <button><a href="/streetFood.html">Order Now</a></button>
                        </div>
                        <div class="contact">
                            <button><a class="btn-contct" href="#contact">Contact Us</a></button>
                        </div>
                       </div>
