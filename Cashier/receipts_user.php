        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item"><a class="nav-link active" aria-current="page" href="receipts.php">Receipts</a></li>
                    <a href="../index.php" class="btn btn-light"><i class="bi bi-box-arrow-in-right me-2"></i>Return</a></a></li>
                </ul>
            </div>
        </div>
    </nav>
